...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','jammy-20221130')
...
export JAVA_VER_DISTRO_19 := env_var_or_default('JAVA_VER_DISTRO_19','19.0.1-zulu')
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','1.8.0')
export KSCRIPT_VER := env_var_or_default('KSCRIPT_VER','4.2.0')
export SCALA_VER := env_var_or_default('SCALA_VER','3.2.1')
export ANT_VER := env_var_or_default('ANT_VER','1.10.12')
export GRADLE_VER := env_var_or_default('GRADLE_VER','7.6')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.8.7')
export SBT_VER := env_var_or_default('SBT_VER','1.8.2')
...
export CASSANDRA_TRUNK_PARENT_TAG := env_var_or_default('CASSANDRA_TRUNK_PARENT_TAG','11')
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','530bc10b')
export CASSANDRA_TRUNK_DISTRO_VERSION := env_var_or_default('CASSANDRA_TRUNK_DISTRO_VERSION','4.2')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','ff2a3023')
