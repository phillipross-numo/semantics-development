...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','jammy-20230425')
...
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.2')
export SBT_VER := env_var_or_default('SBT_VER','1.8.3')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','b72da026')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','6acc542c')
