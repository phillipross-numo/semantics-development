...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_GIT_COMMIT_ID','b171b4ba')
...
export JENA_GIT_COMMIT_ID := env_var_or_default('JENA_GIT_COMMIT_ID','c4e999d6')
