...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','jammy-20221101')
...
export CASSANDRA_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_GIT_COMMIT_ID','279f284d')
...
export JENA_GIT_COMMIT_ID := env_var_or_default('JENA_GIT_COMMIT_ID','cbaa62bb')
