...
export KOTLIN_VER := env_var_or_default('KOTLIN_VER','1.7.21')
...
export SBT_VER := env_var_or_default('SBT_VER','1.8.0')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_GIT_COMMIT_ID','5825a14f')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','1df965f5')
