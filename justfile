...
export GRADLE_VER := env_var_or_default('GRADLE_VER','8.0.1')
export MAVEN_VER := env_var_or_default('MAVEN_VER','3.9.0')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','2ea47b1b')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','9712c016')
