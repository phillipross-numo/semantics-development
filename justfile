...
export CASSANDRA_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_GIT_COMMIT_ID','fb09a5c1')
...
export JENA_GIT_COMMIT_ID := env_var_or_default('JENA_GIT_COMMIT_ID','748fc2d0')
