...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','jammy-20230301')
...
export GRADLE_VER := env_var_or_default('GRADLE_VER','8.0.2')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','4e17922b')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','77ff5ae0')
