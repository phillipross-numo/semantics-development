...
export CASSANDRA_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_GIT_COMMIT_ID','13654332')
...
export JENA_GIT_COMMIT_ID := env_var_or_default('JENA_GIT_COMMIT_ID','a80f0ca3')
