...
export CASSANDRA_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_GIT_COMMIT_ID','88dc64d2')
...
export JENA_GIT_COMMIT_ID := env_var_or_default('JENA_GIT_COMMIT_ID','85c51152')
