...
export UBUNTU_TAG := env_var_or_default('UBUNTU_TAG','jammy-20230522')
...
export SBT_VER := env_var_or_default('SBT_VER','1.9.0')
...
export CASSANDRA_TRUNK_GIT_COMMIT_ID := env_var_or_default('CASSANDRA_TRUNK_GIT_COMMIT_ID','914484df')
...
export JENA_MAIN_GIT_COMMIT_ID := env_var_or_default('JENA_MAIN_GIT_COMMIT_ID','67170788')
